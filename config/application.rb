...
module Daymaven
  class Application < Rails::Application
    ...
    config.action_view.javascript_expansions[:gmaps] = %w(http://maps.google.com/maps/api/js?&sensor=false&key=ABQIAAAAnlzUvzCoMlSC-rAYXxLPbhR571c-r_cMBqJF57lhLDKElNB3_xQ05nTyDOnRX6zOHqMNnUp2L15fGg)
